...
abstract contract BaseScript is Script {
    ...
    constructor() {
        ...
        if (deployerPrivateKey != 0) {
            ...
            // if (block.chainid == 295) {  // Mainnet
            //     broadcaster = vm.envAddress("HEDERA_EVM_ADDRESS");  // Добавь в .env
            //     console.log("Hedera EVM address override:", broadcaster);
            // }
        } else {
        ...
        // broadcaster = vm.envAddress("HEDERA_EVM_ADDRESS");
